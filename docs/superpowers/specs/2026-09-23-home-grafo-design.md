...
- **Medido con el arte (2026-09-26, Lighthouse 13.5 en local, mediana de 5):** móvil 97 / LCP 2.50 s / TBT 117 ms / CLS 0 en `/es` y 97 / 2.15 s / 128 ms / 0 en `/en`; escritorio 100 / 0.60 s en los dos. HTML de `/es`: 52 KB gz; JS de la ruta crítica 132 873 B (margen de 247 B). Pendiente, si hiciera falta volver a 99: sacar el HTML del arte del documento (JSON con hash pedido al hidratar e insertado caja a caja).
