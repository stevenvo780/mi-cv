...
- **Layout raíz (portal y 404 de `[locale]`):** todas sus fuentes son archivos locales (`next/font/local`) y **ninguna se precarga**: una precarga en el layout raíz se descargaría también en la home.
  ...
  - Lo que ninguna fuente de origen tiene sigue en la fuente del sistema: «ḗ» y su versal «Ḗ» en Cormorant y JetBrains Mono; ε, Π y ◎ en Cormorant; y ⚔ ◈ ⊢ ◉ ⚙ ▣ ⏱ ▦ ⬡, que no están en ninguna de las cinco familias.
