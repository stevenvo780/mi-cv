...
- **Home:** cada catálogo abre la rejilla de su frente, a todo lo ancho y antes de las demás tarjetas: es un trabajo más del frente, uno que reúne otros. Cada uno es una tarjeta ancha con el color de su marca, un borde de luz que la recorre (`--cat-angle`, como el de «Pregúntame»), dos hojas apiladas detrás que se abren en abanico con el puntero o el foco, el rótulo «Catálogo · N …», la cifra en contorno y, debajo, la lista entera de lo que contiene, por colección (columnas en escritorio, carrusel horizontal por debajo de 600 px). Cada ítem con URL enlaza directo.
