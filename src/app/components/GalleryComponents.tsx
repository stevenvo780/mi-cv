 ...
 *                      (Ciencias = Kósmos + Estructuras) — owner-approved, untouched.
...
export const BRAND_COVER_PORTRAIT: Record<string, string> = {
  // Filosofía grid (count 3): Paideía, Agón y la ponencia Hinton son cards
  // portrait uniformes (sin destacados). Estructuras Preontológicas YA NO está
  // aquí: pasó a Ciencias (count 2 → featured horizontal) y usa su og_product.
  ...
  // Áporía pasó a Ingeniería (count 11 → grid): ahora SÍ lee un portrait 4:5.
